...
class ForgotPasswordController extends Controller
{
    ...
    public function submitForgetPasswordForm(Request $request)
    {
        ...
        Mail::send('emails.forgetPassword', ['token' => $token], function (
            $message
        ) use ($request) {
    ...
    public function submitAdminForgetPasswordForm(Request $request)
    {
        ...
        Mail::send('emails.adminforgetPassword', ['token' => $token], function (
            $message
        ) use ($request) {
            $message->to($request->email);
            $message->subject('Reset Password');
    ...
    public function submitAdminResetPasswordForm(Request $request)
    {
        ...
        DB::table('password_resets')
            ->where(['email' => $request->email])
            ->delete();
        return redirect('/mountain-guide/login')->with(
            'message',
