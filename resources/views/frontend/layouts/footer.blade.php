...
<footer id="footer">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 newsletter-flex">
                    ...
                    <p class="newsletter-para text-center">Subscribe to our news letter and we’ll keep you up to date on our products and services.</p>
    ...
    <div class="footer-top mt-6">
        <div class="container">
            ...
            <div class="row mt-4 footer-second">
            ...
            <div class="row mt-4 footer-last">
                <div class="col-lg-6 col-md-12 footer-copyright">
                    <p>© {{ Carbon\Carbon::now()->format('Y') }}, All Rights Reserved, Design & Developed By: <a href="https://www.dristicode.com/" target="__blank" class="text-decoration-none"> Dristicode Solutions Pvt. Ltd</a></p>
                </div>
                        ...
                        <div class="d-flex ">
                            @foreach ($affilated as $affilate)
                                @if ($affilate->type == 'pay-method')
                                    <img src="{{ $affilate->image }}" alt="{{ $affilate->type }}">
                                @endif
                            @endforeach
                        </div>
                    </div>
