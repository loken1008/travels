        ...
        <div class="container mt-5 mb-5">
            <div class="row no-gutters">
                <div class="allblogs-heading">
                    <h2 class="populartrektitle layout2">User Dashboard</h2>
                        ...
                        <div class="input-group mb-3 px-2 py-2  bg-white shadow-sm">
                            <form action="{{ route('image.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <button type="submit" for="update" class="btn btn-light ml-4 w-100 mt-4 px-4"> <small
                ...
                <div class="col-md-8 col-lg-8">
                    <div class="d-flex flex-column justify-content-evenly p-1 text-dark c-profile">
                        <h5 class="dashboard-profile">Name: {{ Auth()->guard('customer')->user()->first_name }}
                            {{ Auth()->guard('customer')->user()->last_name }}</h5>
                        <h5 class="dashboard-profile">Email: {{ Auth()->guard('customer')->user()->email }}</h5>
                        <h5 class="dashboard-profile">Address: {{ Auth()->guard('customer')->user()->address }}</h5>
                        <h5 class="dashboard-profile">Mobile No: {{ Auth()->guard('customer')->user()->mobile }}</h5>
                        <h5 class="dashboard-profile">Country: {{ Auth()->guard('customer')->user()->country }}</h5>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-3 p-0">
                    <div class="contact-text">
                        <div class="contact-info">
                            ...
                            <h6> <a class="text-decoration-none" href="#"> Dashboard</a></h6>
                        </div>
                        <div class="contact-info">

                            <h6> <a class="text-decoration-none" href="#" data-bs-toggle="modal"
                                    data-bs-target="#exampleModalCenter{{ Auth()->guard('customer')->user()->id }}">Update
                                    Profile</a></h6>
                        </div>
                        <div class="contact-info">

                            <h6> <a class="text-decoration-none" href="#" data-bs-toggle="modal"
                                    data-bs-target="#exampleModalCenterPass{{ Auth()->guard('customer')->user()->id }}">
                                    Change Password</a></h6>
                        </div>
                        <div class="contact-info">

                            <h6> <a class="text-decoration-none" href="{{ route('customer.logout') }}"> Logout</a></h6>
                        </div>
                    </div>
                </div>
