    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h4 class="box-title">Update Destination Place</h4>
            </div>
            <!-- /.box-header -->
                   ...
                   @csrf
                    ...
                    <section>
                        ...
                        <div class="form-group">
                          ...
                          <textarea id="my-editor"  class="form-control" name="description" value="{{$editplace->description}}">{{$editplace->description}}</textarea>
                        @error('description')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                        </div>
