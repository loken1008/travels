                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="firstName5" style="font-size:14px">Tour Name :</label>
                       ...
                       @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="firstName5 h2 " style="font-size:14px">Blog Type :</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="firstName5 h2 " style="font-size:14px">  Image :</label>
