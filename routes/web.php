...
/*************************************** admin route *********************************/
Route::group(['prefix' => 'mgiadmin', 'middleware' => ['auth','get.expire']],function () {
    ...
    // usermessage
    Route::get('/users-message', [App\Http\Controllers\Admin\UserController::class, 'usersMessage'])->name('all.usermessage');
    Route::get('/usermessage/delete/{id}', [App\Http\Controllers\Admin\UserController::class, 'deleteUsermessage'])->name('usermessage.delete');
    // country
    Route::prefix('country')->group(function () {
        Route::get('/view', [App\Http\Controllers\Admin\CountryController::class, 'viewCountry'])->name('country.view');
        Route::get('/create', [App\Http\Controllers\Admin\CountryController::class, 'createCountry'])->name('country.create');
        Route::post('/store', [App\Http\Controllers\Admin\CountryController::class, 'storeCountry'])->name('country.store');
        Route::get('/edit/{id}', [App\Http\Controllers\Admin\CountryController::class, 'editCountry'])->name('country.edit');
        Route::post('/update/{id}', [App\Http\Controllers\Admin\CountryController::class, 'updateCountry'])->name('country.update');
        Route::get('/delete/{id}', [App\Http\Controllers\Admin\CountryController::class, 'deleteCountry'])->name('country.delete');
        Route::get('/changeStatus', [App\Http\Controllers\Admin\CountryController::class, 'changeStatus']);
    });

    // place
    Route::prefix('place')->group(function () {
        Route::get('/view', [App\Http\Controllers\Admin\PlaceController::class, 'viewPlace'])->name('place.view');
        Route::get('/create', [App\Http\Controllers\Admin\PlaceController::class, 'createPlace'])->name('place.create');
        Route::post('/store', [App\Http\Controllers\Admin\PlaceController::class, 'storePlace'])->name('place.store');
        Route::get('/edit/{id}', [App\Http\Controllers\Admin\PlaceController::class, 'editPlace'])->name('place.edit');
        Route::post('/update/{id}', [App\Http\Controllers\Admin\PlaceController::class, 'updatePlace'])->name('place.update');
        Route::get('/delete/{id}', [App\Http\Controllers\Admin\PlaceController::class, 'deletePlace'])->name('place.delete');
        Route::get('/changeStatus', [App\Http\Controllers\Admin\PlaceController::class, 'changeStatus']);
    });

    /************* hotel **********/
    Route::prefix('hotel')->group(function () {
        Route::get('/view', [App\Http\Controllers\Admin\HotelController::class, 'viewHotel'])->name('hotel.view');
        Route::get('/details/{id}', [App\Http\Controllers\Admin\HotelController::class, 'viewHotelDetails'])->name('hotel.viewdetails');
        Route::get('/create', [App\Http\Controllers\Admin\HotelController::class, 'createHotel'])->name('hotel.create');
        Route::post('/store', [App\Http\Controllers\Admin\HotelController::class, 'storeHotel'])->name('hotel.store');
        Route::get('/edit/{id}', [App\Http\Controllers\Admin\HotelController::class, 'editHotel'])->name('hotel.edit');
        Route::post('/update/{id}', [App\Http\Controllers\Admin\HotelController::class, 'updateHotel'])->name('hotel.update');
        Route::get('/delete/{id}', [App\Http\Controllers\Admin\HotelController::class, 'deleteHotel'])->name('hotel.delete');
        Route::get('/changeHotelStatus', [App\Http\Controllers\Admin\HotelController::class, 'changeHotelStatus']);
    });

    // blog
    Route::prefix('blog')->group(function () {
        Route::get('/view', [App\Http\Controllers\Admin\BlogController::class, 'viewBlog'])->name('blog.view');
        Route::get('/details/{id}', [App\Http\Controllers\Admin\BlogController::class, 'viewBlogDetails'])->name('blog.viewdetails');
        Route::get('/create', [App\Http\Controllers\Admin\BlogController::class, 'createBlog'])->name('blog.create');
        Route::post('/store', [App\Http\Controllers\Admin\BlogController::class, 'storeBlog'])->name('blog.store');
        Route::get('/edit/{id}', [App\Http\Controllers\Admin\BlogController::class, 'editBlog'])->name('blog.edit');
        Route::post('/update/{id}', [App\Http\Controllers\Admin\BlogController::class, 'updateBlog'])->name('blog.update');
        Route::get('/delete/{id}', [App\Http\Controllers\Admin\BlogController::class, 'deleteBlog'])->name('blog.delete');
        Route::get('/changeblogStatus', [App\Http\Controllers\Admin\BlogController::class, 'changeBlogStatus']);
    });

    Route::get('/viewblog/comment', [App\Http\Controllers\Admin\BlogController::class, 'viewBlogComment'])->name('viewblog.comment');
    Route::get('/viewblog/commentdetails/{id}', [App\Http\Controllers\Admin\BlogController::class, 'viewBlogCommentDetails'])->name('blog.viewcommentdetails');
    Route::get('/delete/blogcomment/{id}', [App\Http\Controllers\Admin\BlogController::class, 'deleteBlogComment'])->name('blog.commentdelete');
    ...
    Route::prefix('tour')->group(function () {
        ...
        Route::get('/softdelete/{id}', [App\Http\Controllers\Admin\TourController::class, 'softDeleteTour'])->name('tour.softdelete');
        ...
        Route::get('/changeStatus', [App\Http\Controllers\Admin\TourController::class, 'changeStatus']);
    });
    Route::get('/place/ajax/{category_id}', [App\Http\Controllers\Admin\TourController::class, 'getPlace']);

    // coupon
    Route::prefix('coupon')->group(function () {
        Route::get('/view', [App\Http\Controllers\Admin\CouponController::class, 'viewCoupon'])->name('coupon.view');
        Route::post('/store', [App\Http\Controllers\Admin\CouponController::class, 'storeCoupon'])->name('coupon.store');
        Route::get('/edit/{id}', [App\Http\Controllers\Admin\CouponController::class, 'editCoupon'])->name('coupon.edit');
        Route::post('/update}', [App\Http\Controllers\Admin\CouponController::class, 'updateCoupon'])->name('coupon.update');
        Route::get('/delete/{id}', [App\Http\Controllers\Admin\CouponController::class, 'deleteCoupon'])->name('coupon.delete');
        Route::get('/changeStatus', [App\Http\Controllers\Admin\CouponController::class, 'changeStatus']);
    });
    ...
    Route::prefix('banner')->group(function () {
        ...
        Route::get('homepage', [App\Http\Controllers\Admin\HomePageController::class, 'homePage'])->name('homepage.view');
        Route::post('homepage-store', [App\Http\Controllers\Admin\HomePageController::class, 'homePageStore'])->name('homepage.store');
        Route::get('homepage-edit/{id}', [App\Http\Controllers\Admin\HomePageController::class, 'homePageEdit'])->name('homepage.edit');
        Route::post('homepage-update/{id}', [App\Http\Controllers\Admin\HomePageController::class, 'homePageUpdate'])->name('homepage.update');
        Route::get('homepage-delete/{id}', [App\Http\Controllers\Admin\HomePageController::class, 'homePageDelete'])->name('homepage.delete');
    });

    Route::get('/site-map', [App\Http\Controllers\Admin\HomePageController::class, 'siteMap'])->name('site-map');
    ...
    Route::prefix('sitesetting')->group(function () {
        ...
        // pageBanner
        Route::get('/pagebanner', [App\Http\Controllers\Admin\SiteSettingController::class, 'pageBannerView'])->name('all.pagebanner');
        Route::post('/store/pagebanner', [App\Http\Controllers\Admin\SiteSettingController::class, 'pageBannerStore'])->name('store.pagebanner');
        Route::get('/edit/pagebanner/{id}', [App\Http\Controllers\Admin\SiteSettingController::class, 'pageBannerEdit'])->name('edit.pagebanner');
...
Route::group(['middleware' => ['XSS','get.expire']], function () {
    ...
    Route::get('/tourdetails/{slug}', [App\Http\Controllers\User\IndexController::class, 'tourDetails'])->name('tourdetails');
    Route::get('/tourmap/{slug}', [App\Http\Controllers\User\IndexController::class, 'tourMap'])->name('tourmap');
    // subcategory related details
    Route::get('/tripdetails/{slug}', [App\Http\Controllers\User\CategoryController::class, 'tripDetails'])->name('tripdetails');
    Route::get('/booking/{slug}', [App\Http\Controllers\User\BookingController::class, 'onlineBooking'])->name('booking');
